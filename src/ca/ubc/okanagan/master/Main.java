...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		XMLWriter.writeAsXml(courseContainer, "courses.xml");
		
		System.out.println("Done");
		
		System.out.println("WARNING: If you get an XML error, it means there is a new illegal char that is not present in the illegal.dat file. You need to find this char using a text editor and add it to the illegal.dat file, then re-run the program.");
	}
